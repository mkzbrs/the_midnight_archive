...
## Custom transitions
init:
    $ starTrans = ImageDissolve("gui/starTransition.png", 2, 9)
...
define gui.navigation_button_borders = Borders(20, 6, 20, 6)
...
define gui.notify_frame_borders = Borders(100, 8, 100, 8)
