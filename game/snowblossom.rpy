# Snow Blossom
image light1 = Fixed(SnowBlossom("gui/particles/light1.png", 15, xspeed=(20, 50), yspeed=(25, 300), start=50))
image light2 = Fixed(SnowBlossom("gui/particles/light2.png", 15, xspeed=(20, 50), yspeed=(50, 300), start=50))
image light3 = Fixed(SnowBlossom("gui/particles/light3.png", 50, xspeed=(20, 50), yspeed=(50, 300), start=50))
image light4 = Fixed(SnowBlossom("gui/particles/light4.png", 3, xspeed=(20, 50), yspeed=(100, 300), start=50))
...
init python:
    ...
    # Snow particles
    # ----------------
    def Snow(image, max_particles=50, speed=10, wind=0, xborder=(0,100), yborder=(50,400), **kwargs):
        """
